...
const moods = [
  {
    ...
    label: 'Beach Escape',
    icon: Umbrella,
    description: 'Coastal serenity & sunsets',
  ...
  },
  {
    ...
    icon: Mountain,
    description: 'Peak tranquility & adventure',
  ...
  },
  {
    ...
    icon: Landmark,
    description: 'Timeless culture & history',
  ...
  },
  {
    ...
    icon: Binoculars,
    description: 'Jungle thrills & wildlife',
...
const budgets = [
  ...
  },
  {
    ...
    range: '₹2,00,000 - ₹4,99,999',
    color: 'from-orange-500/20 to-red-500/20',
  },
  {
    id: '5L',
    label: '₹5L+',
    description: 'Bespoke indulgence',
    range: '₹5,00,000+',
            ...
            {moods.map((mood) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 ${mood.color}`}
                  />

                  <div className="relative z-10">
                    <div
                      className={`flex h-14 w-14 items-center justify-center rounded-2xl bg-white/5 border border-white/10 transition-all duration-300 ${
          ...
          <div className="grid grid-cols-2 gap-4">
            {travelStyles.map((style) => {
              ...
              return (
                ...
                >
                  <div
                    className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 ${style.color}`}
                  />
          ...
          <div className="grid grid-cols-2 gap-4">
            {budgets.map((budget) => {
              ...
              return (
                ...
                >
                  <div
                    className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 ${budget.color}`}
                  />
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="mt-2 text-xs text-gold-light/70 font-medium">
                      {budget.range}
                    </p>
                  </div>
          ...
          {!isComplete ? (
                      ...
                      return (
                        <div key={step.id} className="flex items-center">
                          ...
                          {index < steps.length - 1 && (
                            <div
                              className={`h-0.5 w-16 sm:w-24 mx-4 transition-all duration-500 ${
                                isDone
            ...
            >
              ...
              <p className="mt-3 text-white/60 max-w-md mx-auto">
                We&apos;re curating the perfect bespoke itinerary based on your
                preferences.
              </p>
              <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
                <Button
                  asChild
                  className="rounded-full px-8 py-5 bg-gold hover:bg-gold-light shadow-lg shadow-gold/20"
                >
                  <Link href="/plan">
                    View My Plan
                    <ArrowRight className="ml-2 h-4 w-4" />
                ...
                <Button
                  onClick={handleReset}
                  variant="ghost"
                  className="rounded-full px-8 py-5 text-white/60 hover:text-white border border-white/10"
                >
                  Start Over
                </Button>
              </div>
